...
#  Association Rules Example in Python
...
##  Methodology
1. Convert the dataset to a **one-hot encoded** DataFrame using `TransactionEncoder`.  
2. Apply the **Apriori algorithm** with a minimum support threshold of `0.6`.  
3. Generate **association rules** with a minimum confidence threshold of `0.7`.  
4. Display the resulting frequent itemsets and rules.
